...
export default function SuperAdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-surface-primary flex flex-col md:flex-row font-sans text-text-primary">
      {/* Mobile Header */}
      <div className="md:hidden bg-surface-secondary border-b border-border-subtle text-text-primary p-4 flex justify-between items-center z-50 relative shadow-lg">
